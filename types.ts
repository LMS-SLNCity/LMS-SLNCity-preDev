...
export interface TestTemplateParameter {
    name: string;
    type: 'number' | 'text' | 'heading' | 'section'; // 'section' for fluid report structures
    unit?: string;
    ...
    subtitle?: string; // For section headers - appears as subheading/sidebar label
    fields?: TestTemplateParameter[]; // For section type - nested fields within section
}
...
export interface TestTemplate {
  ...
  reportType: 'standard' | 'culture' | 'fluid';
...
export interface Visit {
  ...
  b2b_pending_approval?: boolean; // B2B visit awaiting reception approval
